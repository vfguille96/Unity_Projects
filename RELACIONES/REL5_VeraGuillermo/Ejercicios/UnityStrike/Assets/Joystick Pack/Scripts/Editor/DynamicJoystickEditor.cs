...
public class DynamicJoystickEditor : JoystickEditor
{
    ...
    {
        base.DrawValues();
        EditorGUILayout.PropertyField(moveThreshold, new GUIContent("Move Threshold", "The distance away from the center inputVector has to be before the joystick begins to move."));
    }
}